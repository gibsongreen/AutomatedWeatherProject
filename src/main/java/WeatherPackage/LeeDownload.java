...
public class LeeDownload {
    public void gpsSelector(ChromeDriver driver6) {
        //
        try {
    ...
    public void GPS_Downloader_Img(ChromeDriver driver6) {
        // navigate to the radar page
        navigateToRadar(driver6);

        // Geolocate the ROI for the image
        gpsSelector(driver6);
